...
public class RequesterProvideProblemInformation extends BackEndAction {

  public RequesterProvideProblemInformation() {
    super("provide_problem_information");
  }
  ...
  public int execute(final HttpServletRequest request, final StringBuffer output) throws ServletException, IOException {
    ...
    if (resCode == ResultCode.OK) {
      ...
      resCode = backend.Requester_ProvideProblemInformation(si);
    }
    return resCode;
  }
