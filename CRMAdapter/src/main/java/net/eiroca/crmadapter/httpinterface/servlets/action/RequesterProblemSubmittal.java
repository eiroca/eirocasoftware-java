...
public class RequesterProblemSubmittal extends BackEndAction {

  public RequesterProblemSubmittal() {
    super("problem_submittal");
  }
  ...
  public int execute(final HttpServletRequest request, final StringBuffer output) throws ServletException, IOException {
    ...
    if (resCode == ResultCode.OK) {
      ...
      resCode = backend.Requester_ProblemSubmittal(si);
    }
    return resCode;
  }
