...
import net.eiroca.crmadapter.process.IAdapterBackEnd;

public abstract class BackEndAction implements IAction {

  public String actionName;
  IAdapterBackEnd backend = Adapter.getBackEnd();

  public BackEndAction(final String actionName) {
  ...
  public ServiceIncident loadServiceIncident(final HttpServletRequest request) {
    //TODO Completare
